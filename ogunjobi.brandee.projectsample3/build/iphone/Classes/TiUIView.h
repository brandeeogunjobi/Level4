...
/**
 Base class for all ogunjobibrandeeprojectsample3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ogunjobibrandeeprojectsample3 view hierarchy (such as wrapped iOS UIViews) was touched.
