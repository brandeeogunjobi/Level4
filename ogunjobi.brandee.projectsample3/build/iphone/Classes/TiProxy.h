...
//Rare exceptions to indicate a bug in the _ogunjobibrandeeprojectsample3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ogunjobibrandeeprojectsample3 proxies.
 */
