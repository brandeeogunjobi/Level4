...
// in simulator we redefine to format for ogunjobibrandeeprojectsample3 Developer console
...
{\
	NSString * exceptionName = [@"org.ogunjobibrandeeprojectsample3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ogunjobibrandeeprojectsample3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIogunjobibrandeeprojectsample3NativeItemNone = -1, 
	UIogunjobibrandeeprojectsample3NativeItemSpinner = -2,
	UIogunjobibrandeeprojectsample3NativeItemProgressBar = -3,
	
	UIogunjobibrandeeprojectsample3NativeItemSlider = -4,
	UIogunjobibrandeeprojectsample3NativeItemSwitch = -5,
	UIogunjobibrandeeprojectsample3NativeItemMultiButton = -6,
	UIogunjobibrandeeprojectsample3NativeItemSegmented = -7,
	
	UIogunjobibrandeeprojectsample3NativeItemTextView = -8,
	UIogunjobibrandeeprojectsample3NativeItemTextField = -9,
	UIogunjobibrandeeprojectsample3NativeItemSearchBar = -10,
	
	UIogunjobibrandeeprojectsample3NativeItemPicker = -11,
	UIogunjobibrandeeprojectsample3NativeItemDatePicker = -12,
	
	UIogunjobibrandeeprojectsample3NativeItemInfoLight = -13,
	UIogunjobibrandeeprojectsample3NativeItemInfoDark = -14,
	
	UIogunjobibrandeeprojectsample3NativeItemDisclosure = -15,
	
	UIogunjobibrandeeprojectsample3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ogunjobibrandeeprojectsample3 instances of
