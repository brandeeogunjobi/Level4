...
@interface ogunjobibrandeeprojectsample3Object : KrollCoverageObject {
#else
@interface ogunjobibrandeeprojectsample3Object : KrollObject {
#endif
@private
...
extern NSString * ogunjobibrandeeprojectsample3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ogunjobibrandeeprojectsample3Object *_ogunjobibrandeeprojectsample3;
    KrollObject* console;
	BOOL shutdown;
