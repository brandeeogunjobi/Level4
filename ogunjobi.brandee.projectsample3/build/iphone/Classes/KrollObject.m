...
//@interface ogunjobibrandeeprojectsample3Object : NSObject
//@end

@interface ogunjobibrandeeprojectsample3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ogunjobibrandeeprojectsample3Object class]])
		{
			for (NSString *key in [[(ogunjobibrandeeprojectsample3Object*)o modules] allKeys])
			{
