...
/**
 The base class for all ogunjobibrandeeprojectsample3 modules
 */
...
/**
 ogunjobibrandeeprojectsample3 Platform calls this method on startup.
 */
-(void)startup;

/**
 ogunjobibrandeeprojectsample3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ogunjobibrandeeprojectsample3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ogunjobibrandeeprojectsample3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ogunjobibrandeeprojectsample3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
