...
/**
 The base class for all Ogunjobi_Brandee_Project1 modules
 */
...
/**
 Ogunjobi_Brandee_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Ogunjobi_Brandee_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Ogunjobi_Brandee_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Ogunjobi_Brandee_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Ogunjobi_Brandee_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
