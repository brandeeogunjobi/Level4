...
//@interface Ogunjobi_Brandee_Project1Object : NSObject
//@end

@interface Ogunjobi_Brandee_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ogunjobi_Brandee_Project1Object class]])
		{
			for (NSString *key in [[(Ogunjobi_Brandee_Project1Object*)o modules] allKeys])
			{
