...
//Rare exceptions to indicate a bug in the _ogunjobi_brandee_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Ogunjobi_Brandee_Project1 proxies.
 */
