...
/**
 Base class for all Ogunjobi_Brandee_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Ogunjobi_Brandee_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
