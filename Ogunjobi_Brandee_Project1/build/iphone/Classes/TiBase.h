...
// in simulator we redefine to format for Ogunjobi_Brandee_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.ogunjobi_brandee_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ogunjobi_brandee_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOgunjobi_Brandee_Project1NativeItemNone = -1, 
	UIOgunjobi_Brandee_Project1NativeItemSpinner = -2,
	UIOgunjobi_Brandee_Project1NativeItemProgressBar = -3,
	
	UIOgunjobi_Brandee_Project1NativeItemSlider = -4,
	UIOgunjobi_Brandee_Project1NativeItemSwitch = -5,
	UIOgunjobi_Brandee_Project1NativeItemMultiButton = -6,
	UIOgunjobi_Brandee_Project1NativeItemSegmented = -7,
	
	UIOgunjobi_Brandee_Project1NativeItemTextView = -8,
	UIOgunjobi_Brandee_Project1NativeItemTextField = -9,
	UIOgunjobi_Brandee_Project1NativeItemSearchBar = -10,
	
	UIOgunjobi_Brandee_Project1NativeItemPicker = -11,
	UIOgunjobi_Brandee_Project1NativeItemDatePicker = -12,
	
	UIOgunjobi_Brandee_Project1NativeItemInfoLight = -13,
	UIOgunjobi_Brandee_Project1NativeItemInfoDark = -14,
	
	UIOgunjobi_Brandee_Project1NativeItemDisclosure = -15,
	
	UIOgunjobi_Brandee_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ogunjobi_Brandee_Project1 instances of
