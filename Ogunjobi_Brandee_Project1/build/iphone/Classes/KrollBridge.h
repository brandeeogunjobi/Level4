...
@interface Ogunjobi_Brandee_Project1Object : KrollCoverageObject {
#else
@interface Ogunjobi_Brandee_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Ogunjobi_Brandee_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ogunjobi_Brandee_Project1Object *_ogunjobi_brandee_project1;
    KrollObject* console;
	BOOL shutdown;
