...
//@interface Ogunjobi_Brandee_Project3Object : NSObject
//@end

@interface Ogunjobi_Brandee_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ogunjobi_Brandee_Project3Object class]])
		{
			for (NSString *key in [[(Ogunjobi_Brandee_Project3Object*)o modules] allKeys])
			{
