...
// in simulator we redefine to format for Ogunjobi_Brandee_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.ogunjobi_brandee_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ogunjobi_brandee_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOgunjobi_Brandee_Project3NativeItemNone = -1, 
	UIOgunjobi_Brandee_Project3NativeItemSpinner = -2,
	UIOgunjobi_Brandee_Project3NativeItemProgressBar = -3,
	
	UIOgunjobi_Brandee_Project3NativeItemSlider = -4,
	UIOgunjobi_Brandee_Project3NativeItemSwitch = -5,
	UIOgunjobi_Brandee_Project3NativeItemMultiButton = -6,
	UIOgunjobi_Brandee_Project3NativeItemSegmented = -7,
	
	UIOgunjobi_Brandee_Project3NativeItemTextView = -8,
	UIOgunjobi_Brandee_Project3NativeItemTextField = -9,
	UIOgunjobi_Brandee_Project3NativeItemSearchBar = -10,
	
	UIOgunjobi_Brandee_Project3NativeItemPicker = -11,
	UIOgunjobi_Brandee_Project3NativeItemDatePicker = -12,
	
	UIOgunjobi_Brandee_Project3NativeItemInfoLight = -13,
	UIOgunjobi_Brandee_Project3NativeItemInfoDark = -14,
	
	UIOgunjobi_Brandee_Project3NativeItemDisclosure = -15,
	
	UIOgunjobi_Brandee_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ogunjobi_Brandee_Project3 instances of
