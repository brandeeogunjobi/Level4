...
@interface Ogunjobi_Brandee_Project3Object : KrollCoverageObject {
#else
@interface Ogunjobi_Brandee_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Ogunjobi_Brandee_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ogunjobi_Brandee_Project3Object *_ogunjobi_brandee_project3;
    KrollObject* console;
	BOOL shutdown;
