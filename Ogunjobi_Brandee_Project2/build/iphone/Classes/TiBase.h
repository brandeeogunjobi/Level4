...
// in simulator we redefine to format for Ogunjobi_Brandee_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.ogunjobi_brandee_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ogunjobi_brandee_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOgunjobi_Brandee_Project2NativeItemNone = -1, 
	UIOgunjobi_Brandee_Project2NativeItemSpinner = -2,
	UIOgunjobi_Brandee_Project2NativeItemProgressBar = -3,
	
	UIOgunjobi_Brandee_Project2NativeItemSlider = -4,
	UIOgunjobi_Brandee_Project2NativeItemSwitch = -5,
	UIOgunjobi_Brandee_Project2NativeItemMultiButton = -6,
	UIOgunjobi_Brandee_Project2NativeItemSegmented = -7,
	
	UIOgunjobi_Brandee_Project2NativeItemTextView = -8,
	UIOgunjobi_Brandee_Project2NativeItemTextField = -9,
	UIOgunjobi_Brandee_Project2NativeItemSearchBar = -10,
	
	UIOgunjobi_Brandee_Project2NativeItemPicker = -11,
	UIOgunjobi_Brandee_Project2NativeItemDatePicker = -12,
	
	UIOgunjobi_Brandee_Project2NativeItemInfoLight = -13,
	UIOgunjobi_Brandee_Project2NativeItemInfoDark = -14,
	
	UIOgunjobi_Brandee_Project2NativeItemDisclosure = -15,
	
	UIOgunjobi_Brandee_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ogunjobi_Brandee_Project2 instances of
