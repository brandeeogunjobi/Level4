...
//@interface Ogunjobi_Brandee_Project2Object : NSObject
//@end

@interface Ogunjobi_Brandee_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ogunjobi_Brandee_Project2Object class]])
		{
			for (NSString *key in [[(Ogunjobi_Brandee_Project2Object*)o modules] allKeys])
			{
