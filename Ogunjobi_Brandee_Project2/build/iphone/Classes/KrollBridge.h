...
@interface Ogunjobi_Brandee_Project2Object : KrollCoverageObject {
#else
@interface Ogunjobi_Brandee_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Ogunjobi_Brandee_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ogunjobi_Brandee_Project2Object *_ogunjobi_brandee_project2;
    KrollObject* console;
	BOOL shutdown;
